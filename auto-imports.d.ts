...
declare global {
  ...
  // @ts-ignore
  export type { BreakpointSize, BlockCoords, Block, Section, SectionStyle, Background, Border, SidesBorders, SideBorder, Sides, Corners, ViewportMode } from './src/types/layout'
